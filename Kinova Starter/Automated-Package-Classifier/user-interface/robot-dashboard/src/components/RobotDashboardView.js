...
const RobotDashboardView = ({ status, stats, logs, statusHistory, error, stopRobot }) => {
  return (
    <div className="dashboard-container">
      ...
      <button className="stop-button" onClick={stopRobot}>
...
export default RobotDashboardView;